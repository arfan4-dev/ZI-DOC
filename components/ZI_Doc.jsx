    ...
    <div ref={menuRef}>
      ...
      <div className="sm:ml-14 sm:mr-8 sm:mt-12 lg:ml-14 lg:mr-10 lg:mt-12 xl:ml-14 xl:mr-10 xl:mt-12 2xl:ml-14 2xl:mr-20 2xl:mt-16 flex items-center justify-between ">
        ...
        <img
          src="/assets/logo.svg"
          alt="logo"
          className="sm:w-[100px] sm:h-[40px] lg:w-[170px] lg:h-[40px] 2xl:w-[204px] 2xl:h-[50px]"
        />

        <div className="flex items-center sm:space-x-3 md:space-x-5 xl:space-x-5 2xl:space-x-10">
          <div>
            <p className=" text-[6px] lg:text-[8px] 2xl:text-[14px] tracking-[2px]">
              17:23 LONDON UNITED KINGDOM
            </p>
            <p className="text-[#BE9F56] lg:ml-10 2xl:ml-20 text-end text-[6px] lg:text-[8px] 2xl:text-[12px] tracking-[2px]">
          ...
          <img
            src="/assets/UK.svg"
            alt="flag logo"
            className="sm:h-[15px] sm:w-[15px] lg:h-[25px] lg:w-[25px]"
          />
      ...
      <div>
        <img
          ...
          alt="AI_LOGO"
          className="absolute sm:right-[35px] lg:right-[42px] 2xl:right-[80px] w-[130px] h-[30px] md:w-[150px] md:h-[30px] xl:w-[150px] xl:h-[30px]  2xl:w-[184px] 2xl:h-[40px]"
        />
        <p className="absolute sm:right-[33px] lg:right-[40px] 2xl:right-[80px] font-bold sm:top-32 md:top-32 2xl:top-44">
          TRY FOR FREE
        </p>
        <div className="bg-[#000000] sm:w-[300px] sm:h-[350px] lg:w-[400px] lg:h-[510px] xl:w-[450px] xl:h-[415px] 2xl:w-[541px] 2xl:h-[846px] absolute sm:top-44 lg:top-48 2xl:top-52 right-0 rounded-bl-[20px] rounded-tl-[20px]">
          <img
