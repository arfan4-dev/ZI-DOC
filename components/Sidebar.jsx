...
function Sidebar(){
    return (
        ...
        <div className="customScrollbar bg-black sm:w-[180px] sm:h-[750px] md:w-[180px] md:h-[750px] lg:w-[200px] lg:h-[840px] xl:w-[200px] xl:h-[850px] 2xl:w-[262px] 2xl:h-[1079px] overflow-auto">
