    ...
    <div>
         <>
            ...
            <Drawer
                ...
                direction='left'
                className='overflow-y-auto customScrollbar md:w-[180px] sm:w-[180px] 2xl:w-[262px] lg:w-[200px] xl:w-[200px]'
                size={250}
                // lockBackgroundScroll={true}
            >
              <div className="customScrollbar bg-black  sm:h-[750px]  md:h-[750px]  lg:h-[840px]  xl:h-[850px]  2xl:h-[1079px] overflow-y-auto">
